...
const vueuseHead_881461f0 = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }], "charset": "utf-8", "link": [{ "rel": "stylesheet", "style": "text/css", "href": "https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" }, { "rel": "stylesheet", "style": "text/css", "href": "https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.0/font/bootstrap-icons.css" }, { "rel": "stylesheet", "href": "http://fonts.cdnfonts.com/css/sofia-pro" }], "style": [], "script": [] }, "mixinKey": "created" };
const plugin_5dfa96fc = defineNuxtPlugin((nuxtApp) => {
...
const NuxtChild = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$g]]);
const layouts = {
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$f]]);
const routes = [
  {
    "name": "index",
    "path": "/",
    "file": "E:/bip-spa/pages/index.vue",
    "children": [],
  ...
  },
  {
    "name": "search",
    "path": "/search",
    "file": "E:/bip-spa/pages/search.vue",
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return search$1;
    })
...
const router_067ba8ba = defineNuxtPlugin((nuxtApp) => {
...
const nitroClient_01e16302 = () => {
};
const components = {
  "Image": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return index$3;
  }).then((c) => c.default || c)),
  "PageZoneEmployess": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return employess;
  }).then((c) => c.default || c)),
  "PageZone": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return index$2;
  }).then((c) => c.default || c)),
  "PageZonePosts": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return posts;
  }).then((c) => c.default || c)),
  "SidebarLeft": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return Left;
  }).then((c) => c.default || c)),
  "SidebarRight": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return Right;
  }).then((c) => c.default || c)),
  "PagePostsLayoutAdvanced": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return advanced$1;
  }).then((c) => c.default || c)),
  "PagePostsLayoutSimple": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return simple$1;
  }).then((c) => c.default || c)),
  "PagePostsSectorHeader": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return header;
  }).then((c) => c.default || c)),
  "PagePostsSectorStats": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return stats;
  }).then((c) => c.default || c))
};
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$e]]);
const _sfc_main$d = {};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$d]]);
let entry;
...
function _sfc_ssrRender$c(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: $props.images.componentClass
  }, _attrs))} data-v-1616b46a><!--[-->`);
  serverRenderer.exports.ssrRenderList($props.images.images, (image, imageId) => {
    _push(`<div data-v-1616b46a><img${serverRenderer.exports.ssrRenderAttr("src", image.src)}${serverRenderer.exports.ssrRenderAttr("alt", image.alt)} class="image img-fluid" data-v-1616b46a>`);
    if ($props.images.hasDescriptions) {
      _push(`<span class="d-flex flex-column" data-v-1616b46a><span class="text-center" data-v-1616b46a>User Name</span><span class="text-center" data-v-1616b46a>Stanowisko</span></span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`</div>`);
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/image/index.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$c], ["__scopeId", "data-v-1616b46a"]]);
...
function _sfc_ssrRender$b(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Image = __nuxt_component_0$4;
  const _component_NuxtLink = vue_cjs_prod.resolveComponent("NuxtLink");
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "d-none d-lg-flex align-items-center bg-white ls flex-column" }, _attrs))} data-v-4bcc1d72>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Image, { images: _ctx.logoImage }, null, _parent));
  _push(`<div class="d-flex sticky-menu flex-column justify-content-evenly align-items-center" data-v-4bcc1d72>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="bi bi-list ls-icon-active" data-v-4bcc1d72${_scopeId}></i>`);
      } else {
        return [
          vue_cjs_prod.createVNode("i", { class: "bi bi-list ls-icon-active" })
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/search" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="bi bi-search ls-icon" data-v-4bcc1d72${_scopeId}></i>`);
      } else {
        return [
          vue_cjs_prod.createVNode("i", { class: "bi bi-search ls-icon" })
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<i class="bi bi-book ls-icon" data-v-4bcc1d72></i><i class="bi bi-envelope ls-icon" data-v-4bcc1d72></i><i class="bi bi-info-circle ls-icon" data-v-4bcc1d72></i></div></div>`);
}
const _sfc_setup$b = _sfc_main$b.setup;
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/sidebar/Left.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b], ["__scopeId", "data-v-4bcc1d72"]]);
const Left = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_SidebarLeft = __nuxt_component_0$3;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "container-fluid vh-100 m-background" }, _attrs))} data-v-55366af5><div class="row h-100" data-v-55366af5>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_SidebarLeft, { class: "col-md-2 col-lg-1" }, null, _parent));
  _push(`<div class="col-12 col-lg-11" data-v-55366af5>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-55366af5"]]);
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  serverRenderer.exports.ssrRenderVNode(_push, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent($props.postsLayout), vue_cjs_prod.mergeProps({
    posts: $props.posts,
    postsCategory: $props.postsCategory,
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-zone/posts.vue");
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Image = __nuxt_component_0$4;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "col-12" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Image, {
    images: _ctx.logoImage,
    class: $props.employess.componentClass
  }, null, _parent));
  _push(`</div>`);
}
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-zone/employess.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8]]);
const employess = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_PageZonePosts = __nuxt_component_0$2;
  const _component_PageZoneEmployess = __nuxt_component_1$2;
  _push(`<!--[-->`);
  if ($props.posts) {
    _push(serverRenderer.exports.ssrRenderComponent(_component_PageZonePosts, vue_cjs_prod.mergeProps({
      posts: $props.posts,
      postsLayout: $props.postsLayout,
      boxTitle: $props.boxTitle,
      postsCategory: $props.postsCategory
    }, _attrs), null, _parent));
  } else {
  ...
  if ($props.employess) {
    _push(serverRenderer.exports.ssrRenderComponent(_component_PageZoneEmployess, vue_cjs_prod.mergeProps({ employess: $props.employess }, _attrs), null, _parent));
  } else {
    _push(`<!---->`);
  }
  _push(`<!--]-->`);
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-zone/index.vue");
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Image = __nuxt_component_0$4;
  const _component_PageZone = __nuxt_component_0$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "d-flex flex-column gap-0 gap-lg-4" }, _attrs))} data-v-7fe41cf0><div class="row flex-grow-0" data-v-7fe41cf0><div class="col-12" data-v-7fe41cf0>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Image, { images: _ctx.departmentsImages }, null, _parent));
  _push(`</div></div><div class="row flex-grow-1 posts-gap" data-v-7fe41cf0>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_PageZone, {
    postsLayout: "PagePostsLayoutSimple",
    postsCategory: "zam",
    posts: $props.posts,
    boxTitle: "Zam\xF3wienia publiczne"
  }, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_PageZone, {
    postsLayout: "PagePostsLayoutSimple",
    postsCategory: "work",
  ...
  _push(`</div><div class="row flex-grow-0 mt-3 mt-lg-0" data-v-7fe41cf0>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_PageZone, { employess: _ctx.employess }, null, _parent));
  _push(`</div></div>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/sidebar/Right.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-7fe41cf0"]]);
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_PageZone = __nuxt_component_0$1;
  const _component_SidebarRight = __nuxt_component_1$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "row h-100 px-0 px-sm-2 py-3" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_PageZone, {
    boxTitle: "Zam\xF3wienia publiczne",
    postsLayout: "PagePostsLayoutAdvanced",
    postsCategory: "news",
    posts: _ctx.posts
  }, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_SidebarRight, {
    posts: _ctx.posts,
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("pages/search.vue");
...
const _sfc_main$3 = {
  ...
  methods: {
    ...
    transformTitle(postTitle, sliceLength) {
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[-->`);
  if ($options.isSimplePost()) {
    _push(`<span${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-70e1b970><i class="bi bi-caret-right-fill text-danger" data-v-70e1b970></i>${serverRenderer.exports.ssrInterpolate($options.transformTitle($props.postTitle, 45))}</span>`);
  } else {
    _push(`<!---->`);
  }
  if ($options.isExpandPost()) {
    _push(`<p${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h5" }, _attrs))} data-v-70e1b970>${serverRenderer.exports.ssrInterpolate($options.transformTitle($props.postTitle, 60))}</p>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.boxTitle) {
    _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-danger rs-posts-radius d-flex justify-content-center text-white py-2" }, _attrs))} data-v-70e1b970>${serverRenderer.exports.ssrInterpolate($props.boxTitle)}</div>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.postDescription) {
    _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-70e1b970><small class="text-muted" data-v-70e1b970>${serverRenderer.exports.ssrInterpolate($options.transformTitle($props.postDescription, 210))}</small></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<!--]-->`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-posts/sector/header.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-70e1b970"]]);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "mt-3 d-flex d-flex-xs-column justify-content-between align-items-center" }, _attrs))} data-v-67c3f61a>`);
  if ($props.isReadMore) {
    _push(`<div class="flex-grow-1" data-v-67c3f61a><button class="btn btn-danger ls-border-radius" data-v-67c3f61a>Czytaj wi\u0119cej</button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="flex-grow-1 d-flex flex-wrap justify-content-evenly justify-content-xs-center mt-2 mt-0" data-v-67c3f61a><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.statsIcons, (statIcon, statIndex) => {
    _push(`<small class="text-muted mx-2" data-v-67c3f61a><i class="${serverRenderer.exports.ssrRenderClass(statIcon.icon)}" data-v-67c3f61a></i> ${serverRenderer.exports.ssrInterpolate(statIcon.iconValue ? statIcon.iconValue : $props.createdAt)}</small>`);
  });
  _push(`<!--]--></div></div>`);
}
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-posts/sector/stats.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-67c3f61a"]]);
const stats = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
const _sfc_main$1 = {
  ...
  methods: {
    getPostsClassLayout(postIndex) {
      let advancedClass = "advanced-post-" + postIndex;
      return "mb-2 " + advancedClass;
    },
    calculatePostsCount() {
      let postsBoxHeight = this.$refs.advancedPostsBox.clientHeight;
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_PagePostsSectorHeader = __nuxt_component_0;
  const _component_PagePostsSectorStats = __nuxt_component_1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: "col-12 col-xl-6 d-flex flex-column justify-content-flex-start justify-content-xxl-between",
    ref: "advancedPostsBox"
  }, _attrs))} data-v-795ddaf8>`);
  if ($props.posts[$props.postsCategory]) {
    _push(`<!--[-->`);
    serverRenderer.exports.ssrRenderList($props.posts[$props.postsCategory], (post, postIndex) => {
      _push(`<div class="${serverRenderer.exports.ssrRenderClass([$options.getPostsClassLayout(postIndex), "callout callout-danger"])}" data-v-795ddaf8>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_PagePostsSectorHeader, {
        postTitle: post.Title,
        postDescription: post.Title
      }, null, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(_component_PagePostsSectorStats, {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-posts/layout/advanced.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const advanced = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-795ddaf8"]]);
const advanced$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": advanced
});
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_PagePostsSectorHeader = __nuxt_component_0;
  const _component_PagePostsSectorStats = __nuxt_component_1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "col-xxl-6 col-xl-12 col-12 col-sm-6 mt-3 mt-lg-0" }, _attrs))}><div class="bg-white ls-border-radius ls h-100">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_PagePostsSectorHeader, { boxTitle: $props.boxTitle }, null, _parent));
  if ($props.posts[$props.postsCategory]) {
    _push(`<!--[-->`);
    serverRenderer.exports.ssrRenderList($props.posts[$props.postsCategory].slice(0, 3), (post) => {
      _push(`<div class="px-3 py-2">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_PagePostsSectorHeader, {
        isSimple: true,
        postTitle: post.Title
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/page-posts/layout/simple.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const simple = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
const simple$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": simple
});
